...
ACCESS_TOKEN = os.environ.get('token') #bot token from @botFather in config vars on heroku.com

VERIFY_TOKEN = os.environ.get('vtoken') #bot token from @botFather in config vars on heroku.com
